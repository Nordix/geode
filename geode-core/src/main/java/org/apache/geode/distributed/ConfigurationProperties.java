...
public interface ConfigurationProperties {
  ...
  /**
   * The static String definition of the <i>"security-common-name-auth-enabled"</i> property
   * </p>
   *
   ...
   * </p>
   */
  String SECURITY_COMMON_NAME_AUTH_ENABLED = SECURITY_PREFIX + "common-name-auth-enabled";
  /**
