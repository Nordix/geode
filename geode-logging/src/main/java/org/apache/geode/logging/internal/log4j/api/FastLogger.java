...
/**
 * If delegating is true then is-enabled checks will be delegated to ExtendedLoggerWrapper.
 *
 * Delegating is used to avoid performance penalties in the following cases:
